...
//default value for temp click button to show
$display_type = '';
...
if(isset($_GET['id'])){
	...
	if(isset($RBT_DataHas)){
		...
		$form_html = '<link rel="stylesheet"  href="'.plugin_dir_url(__FILE__)."../templates/contact/".$template_no."/style.css?".rand(1,1000).'"><div class="template_html_wrapper ">'.$form_html.'</div>';
		...
		if($display_type == 'button_click' &&  isset($customizer_values_array[5])){
			
			$customizer_values_array5 = explode('||',$customizer_values_array[5]);
			if(isset($customizer_values_array5[0])){
				$rbt_temp_click_button_aligment = $customizer_values_array5[0];
			}

			if(isset($customizer_values_array5[1])){
				$rbt_temp_click_button_wid = $customizer_values_array5[1];
			}

			

			if(isset($customizer_values_array5[2])){
				$rbt_temp_click_button_height = $customizer_values_array5[2];
			}

			if(isset($customizer_values_array5[3])){
				$rbt_temp_click_button_backgound_color = $customizer_values_array5[3];
			}

			if(isset($customizer_values_array5[4])){
				$rbt_temp_click_button_margin_top = $customizer_values_array5[4];
			}

			if(isset($customizer_values_array5[5])){
				$rbt_temp_click_button_margin_botton = $customizer_values_array5[5];
			}
	...
	<div class="tab-content p-4" id="rbTabContent">
	  ...
	  <div class="row">
		...
		<div class="col-sm-3 drag_drop_elements_wrapper">
			...
			<div class="rbt_template_customizers_outer customized-optional" style="display:none">
			   <div class="rbt_template_customizers_inner">
				   <div class="Template-Customize-Setting" >
			        ...
			        <div class="rbt_addcustomfield_draggable_elements_wrapper rbt_customizers_innner_sections customized-optional-ul" style="display: none">
					  <?php 
						$data_fields_list = null; //RBT_Fields::load();
